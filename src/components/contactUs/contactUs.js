            ...
            <form id="form" method="post" name="emailform" action="">
                ...
                <div className={cx(Classes.formInputMax)}>
                  ...
                  <div id="textarea" className={cx(Classes.formInputWrapper, Classes.flexboxLeftStart)}>
                    <textarea className={cx(Classes.formInput)} id="message" name="message" placeholder="Write here what specification you found missing." maxlength="500" aria-label="" required></textarea>
                  </div>
                 </div>
